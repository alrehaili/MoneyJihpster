...
import com.oorahimoo.money.domain.Transaction;
import com.oorahimoo.money.repository.TransactionRepository;
...
/**
 * REST controller for managing {@link com.oorahimoo.money.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Transaction> partialUpdateTransaction(
        ...
        Optional<Transaction> result = transactionRepository
            ...
            .map(existingTransaction -> {
                if (transaction.getTransactionIdent() != null) {
                    existingTransaction.setTransactionIdent(transaction.getTransactionIdent());
                }
                if (transaction.getType() != null) {
                    existingTransaction.setType(transaction.getType());
                }
                if (transaction.getHow() != null) {
                    existingTransaction.setHow(transaction.getHow());
                }
