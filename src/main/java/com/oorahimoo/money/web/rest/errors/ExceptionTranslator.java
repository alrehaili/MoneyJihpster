...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.oorahimoo.money.service.EmailAlreadyUsedException ||
            ex instanceof com.oorahimoo.money.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.oorahimoo.money.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.oorahimoo.money");
    }
}
